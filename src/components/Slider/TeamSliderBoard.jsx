...
export default function TeamSlider() {
  ...
  const teamData = [
    {
      memberImage: Speaker9,
      memberName: 'Kionne McGhee',
    ...
    {
      memberImage: Speaker8,
      memberName: 'Stanley Moore',
      memberDesignation: 'First Vice President',
      memberSocial: {
        linkedin: '/',
        twitter: '/',
        youtube: '/',
    ...
    {
      memberImage: Speaker7,
      memberName: 'Angela Conley',
      memberDesignation: 'Second Vice President',
      memberSocial: {
        linkedin: '/',
        twitter: '/',
        youtube: '/',
    ...
    {
      memberImage: Speaker6,
      memberName: 'Royceanne Porter',
    ...
    {
      memberImage: Speaker10,
      memberName: 'Sharon Thompson',
      memberDesignation: 'Treasurer',
      memberSocial: {
        linkedin: '/',
        twitter: '/',
        youtube: '/',
  ...
  return (
    <Div {...settings} className="cs-gap-24 text-black cs-arrow_style2">
